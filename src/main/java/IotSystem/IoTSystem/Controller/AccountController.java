...
public class AccountController {
    ...
    public ResponseEntity<ApiResponse<String>> changePassword(
        ...
        try {
            String result = accountService.changePassword(request);
            ...
            response.setMessage("Failed to change password: " + e.getMessage());
    ...
    public ResponseEntity<ApiResponse<List<ProfileResponse>>> getAllAccounts(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {

        List<ProfileResponse> profiles = accountService.getAllAccounts();
